...
- **hebrew-content-writer** — any time you write or edit user-visible Hebrew copy (UX text, buttons, empty states, errors, aria-labels, marketing). Complements the copy self-audit in `.Codex/rules/common/ui-preflight.md`.
