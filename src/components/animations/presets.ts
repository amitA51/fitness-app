...
export const SPRING_PRESETS = {
  ...
  bouncy: { type: 'spring', bounce: 0.4, duration: 0.4 },
} as const;

/**
 * Semantic motion curves — single source of truth.
 * - settle: feedback, menus, toggles (critically-damped Apple spring, bounce 0)
 * - reveal: page/list transitions (expo ease-out)
 * - playful: celebrations only (underdamped bounce)
 */
export const MOTION_CURVES = {
  settle: { type: 'spring' as const, bounce: 0, duration: 0.35 },
