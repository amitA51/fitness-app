  ...
  return (
    <AnimatePresence>
      {isVisible && (
        ...
        >
          <motion.div
            initial={shouldReduceMotion ? { opacity: 1 } : { scale: 0.5, opacity: 0, y: 50 }}
          ...
          >
            <div className="relative">
              ...
              {/* Main Card */}
              <div className="relative bg-gradient-to-br from-yellow-500/20 to-orange-600/20 backdrop-blur-xl border-2 border-yellow-400/50 rounded-3xl p-6 shadow-2xl min-w-[280px] max-w-[calc(100vw-48px)]">
                {/* Trophy Icon */}
                <motion.div
                ...
                >
                  ...
                  <div className="bg-black/30 rounded-2xl p-4 border border-yellow-400/30">
                    <div className="text-4xl font-black text-yellow-300 mb-1 tabular-nums">
