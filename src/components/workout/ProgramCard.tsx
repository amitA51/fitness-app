...
import { getIconForName } from './common/IconMap';
      ...
      <div className="relative z-10">
        ...
        <div className="flex items-start gap-3 mb-4">
          ...
          <div className="flex-1 min-w-0">
            <h3 className="font-bold text-white text-lg truncate">{program.nameHe}</h3>
            <p className="text-sm text-gray-500">{program.name}</p>
          </div>
        </div>

        {/* Description */}
        <p className="text-sm text-gray-400 mb-4 line-clamp-2">{program.descriptionHe}</p>
