  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 60% 50% at center 40%, var(--dynamic-accent-color, rgba(0,122,255,0.06)) 0%, transparent 100%)',
        }}
      />
      ...
      <h3 className="font-bold mb-2.5 text-lg text-white" style={{ letterSpacing: '-0.01em' }}>
        {title}
      </h3>
